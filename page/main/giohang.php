                    ...
                    foreach($_SESSION['cart'] as $cart_item){
                        ...
                        <div class="spgiohang_cart">
                            ...
                            <div class="cart_spgiohang-sl">
                                <a href="./page/main/themgiohang.php?cong=<?php echo $cart_item['id'] ?>" class="ti-plus"></a>
                                <span name="soluong" class="cart_spgiohang-sl_stt"><?php echo $cart_item['soluong'] ?></span>
                                <a href="./page/main/themgiohang.php?tru=<?php echo $cart_item['id'] ?>" class="ti-minus"></a>
                            </div>
                            ...
                            <div class="cart_spgiohang-thanhtien">
                                ...
                                <a href="./page/main/themgiohang.php?xoa=<?php echo $cart_item['id'] ?>" class="color_red ti-trash"></a>
                            </div>
                        </div>
                ...
                <div class="cart_main-footer">
                    ...
                    <div class="cart_chinhsachdoitra">
                        <ul>
                            ...
                            <li>Sản phẩm được đổi 1 lần duy nhất, không hỗ trợ trả hàng.</li>
        ...
        <div class="cart_main--sidebar">
            ...
            <div class="cart_main--sidebar_main">
                ...
                <div class="cart_main--sidebar_main-3">
                    ...
                    if(isset($_SESSION['dangky'])){
                        ?>
                        <a href="page/main/thanhtoan.php" name="thanhtoan" >THANH TOÁN</a>
                        <?php
                    }else{
                        ?>
                ...
                <ul>
                    <div class="maincontent-item">
                        ...
                        <div class="maincontent-info">
                            ...
                            <a href="index.php?quanly=sanpham&id=<?php echo $row_pro['id_sanpham'] ?>" class="maincontent-gia"><?php if($row_pro['km']>0){ echo number_format($giaspkm).'vnd'; }
