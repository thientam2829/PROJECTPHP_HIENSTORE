            ...
            <div class="detail-wapper-info">
                <div class="detail-left-img">
                    <div class="detail-left-big-img">
                        <img src="/admin/modules/quanlysp/uploads/<?php echo $row_sanpham['hinhanh'] ?>">
                    </div>
                </div>
                    ...
                    <div class="selector-actions">
                         <div class="quantity-area clearfix">
                            <input type="number" id="quantity" name="quantity" value="1" min="1" class="quantity-selector">
                             <span style="font-size:larger;padding-left: 2% ">Số lượng</span>
                        </div>
                        <div class="wrap-addcart clearfix">
                            <div>
                                <form method="POST" action="/page/main/themgiohang.php?idsanpham=<?php echo $row_sanpham['id_sanpham'] ?>">
                                    <button type  = "submit" id="add-to-cart" title = 'Thêm vào giỏ' name="themgiohang" class="giohang add-to-cartProduct button btn-addtocart addtocart-modal">
                                        <a >Thêm vào giỏ</a>
                                    </button>
                                </form>
                        ...
                        <div class="description-content">
                            <div class="description-productdetail">
                                ...
                                <p>
                                    ...
                                    ✦
                                    <strong>&nbsp;&nbsp;</strong>
                                    MENSWEAR BRAND LIMITED&nbsp;&nbsp;✦
                                    <br>
                                    Copyright © 2022 Hiên. All rights reserved
                                </p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
